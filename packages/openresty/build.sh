TERMUX_PKG_HOMEPAGE=https://openresty.org/
TERMUX_PKG_DESCRIPTION="High Performance Web Platform Based on Nginx and LuaJIT"
TERMUX_PKG_LICENSE="BSD 2-Clause"
TERMUX_PKG_MAINTAINER="@ian4hu"
TERMUX_PKG_VERSION="1.25.3.2"
TERMUX_PKG_SRCURL=https://github.com/openresty/openresty/releases/download/v$TERMUX_PKG_VERSION/openresty-$TERMUX_PKG_VERSION.tar.gz
TERMUX_PKG_SHA256=2d564022b06e33b45f7e5cfaf1e5dc571d38d61803af9fa2754dfff353c28d9c
...
termux_step_configure() {
	...
	LUAJIT_CROSS=" CROSS=$NDKCROSS STATIC_CC=$NDKCC DYNAMIC_CC=\"$NDKCC -fPIC\" TARGET_LD=$NDKCC TARGET_AR=\"$NDKBIN/llvm-ar rcus\" TARGET_STRIP=$NDKBIN/llvm-strip" ./configure \
		--prefix=$TERMUX_PREFIX \
		--crossbuild="Linux:3.16.1:$TERMUX_ARCH" \
		--crossfile="$TERMUX_PKG_SRCDIR/bundle/nginx-1.25.3/auto/cross/Android" \
		--with-cc=$CC \
		--with-cpp=$CPP \
